...
$env:GOOS = "windows"
$env:GOARCH = "amd64"
go build -o dmxapi-claude-code.exe .
...
$env:GOOS = "linux"
$env:GOARCH = "amd64"
go build -o dmxapi-claude-code-linux-amd64 .
...
$env:GOOS = "linux"
$env:GOARCH = "arm64"
go build -o dmxapi-claude-code-linux-arm64 .
...
$env:GOOS = "darwin"
$env:GOARCH = "amd64"
go build -o dmxapi-claude-code-macos-amd64 .
...
$env:GOOS = "darwin"
$env:GOARCH = "arm64"
go build -o dmxapi-claude-code-macos-arm64 .
