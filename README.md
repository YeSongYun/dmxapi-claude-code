...
> **说明**：以下示例文件名中的 `v1.9.5` 为版本号示例，请替换为实际下载的版本号。

### Windows x64

```powershell
# 下载后直接运行
.\dmxapi-claude-code-v1.9.5-windows-amd64.exe
```
...
# 添加执行权限
chmod +x dmxapi-claude-code-v1.9.5-linux-amd64

# 运行
./dmxapi-claude-code-v1.9.5-linux-amd64
```
...
# 添加执行权限
chmod +x dmxapi-claude-code-v1.9.5-linux-arm64

# 运行
./dmxapi-claude-code-v1.9.5-linux-arm64
```
...
chmod +x dmxapi-claude-code-v1.9.5-macos-arm64
xattr -cr dmxapi-claude-code-v1.9.5-macos-arm64

# 运行
./dmxapi-claude-code-v1.9.5-macos-arm64
```
...
# 添加执行权限并移除 macOS 安全隔离标记
chmod +x dmxapi-claude-code-v1.9.5-macos-amd64
xattr -cr dmxapi-claude-code-v1.9.5-macos-amd64

# 运行
./dmxapi-claude-code-v1.9.5-macos-amd64
```
...
```bash
xattr -cr dmxapi-claude-code-v1.9.5-macos-arm64  # Apple Silicon
# 或
xattr -cr dmxapi-claude-code-v1.9.5-macos-amd64  # Intel
```
