...
- 手动配置的默认模型填充值改为 claude-opus-5-cc
- 推荐配置与预设列表切到 claude-opus-5-cc

## 1.9.0 (2026-07-23)

### 🎨 代码风格

- 补 clearActiveConfig doc 注释列表块后的空注释行

### 🐛 问题修复

- Token 获取地址路径由 /token 改为 /keys
...
- 预设模型列表替换为 9 个 -cc 模型并按模型标记 1M 上下文
- Dmxapi 推荐配置默认模型改为 claude-fable-5-cc
